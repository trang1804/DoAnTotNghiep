...
<div class="row  col-12">
    <form class="user  col-12 d-sm-flex align-items-center justify-content-between" action="{{ route('cp-admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name_blog"value="{{ old('name_blog') }}" id="name_blog" onchange="ChangeToSlug('name_blog','slug_blog')" class="form-control form-control-user" placeholder="Tiêu đề bài viết ...">
                        @error('name_blog')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('slug_blog') }}" id="slug_blog" name="slug_blog" class="form-control form-control-user" placeholder="Slug đề bài viết ...">
                        @error('slug_blog')
                        <span class="text-danger">
                            {{$message}}
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="short_description" rows="3">{{ old('short_description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="summernote" name="description"  rows="7">{{ old('description') }}</textarea>
                        @error('description')
                        <span class="text-danger">
                            {{$message}}
                        </span>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <select class="custom-select" name="status" id="inputGroupSelect01">
                            <option selected value="1">Đã duyệt bài viết</option>
                            <option value="0">Chờ duyệt bài viết</option>
                        </select>
                        @error('status')<span class="text-danger">{{$message}}</span>@enderror
                    </div>
                    <div class="form-group">
                    <label for="slugCategories">Hình ảnh</label>
                        <div class="mt-3 " style="width: 100%; height: 150px; text-align: center;" id="imgavatar2">
