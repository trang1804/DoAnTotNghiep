                            ...
                            <form name="fillter_pro" class="" action="" method="get">
                                ...
                                <div class="range-slider">
                                    <div class="price-input d-flex justify-content-between">
                                        <input type="text" name="min" value="2" id="minamount">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__discount__item">
                            ...
                            <div class="product__discount__item__text">
                                <h5><a href="{{ $product->slug }}">{{ $product->disnameProcounts }}</a></h5>
                                <div class="product__item__price">$30.00 <span>{{ number_format($product->price, 0, ',', '.') . " VNĐ" }}</span></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
