                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{ asset('storage/' . $config->logo) }}" alt="Cart Icon"
                                      title="Cart Icon"
                          ...
                          <tr>
                            <td
                              ...
                              <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><strong>{{$data['fullname']}} bạn đ&atilde; được cấp t&agrave;i
                                    khoản nh&acirc;n vi&ecirc;n</strong></p>
                              </div>
                            ...
                            <td
                              ...
                              <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%; text-align: justify;"><span
                                    ...
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>T&agrave;i khoản
                                      đăng nhập</strong> : <a rel="noopener" href="mailto:{{$data['email']}}"
                                      target="_blank">{{$data['email']}}</a></span></p>
                                <p style="font-size: 14px; line-height: 140%; text-align: justify;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">&nbsp;
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Mật khẩu:
                                    {{$data['passwordNew']}}</strong></span></p>
